<?php 
$sql = $mysqlClient->prepare('SELECT u.*, t.content, t.id as tweet_id, t.time FROM tweet t JOIN user u ON u.id = t.id_user WHERE t.id_user = :id AND t.id_response IS NULL ORDER BY t.id DESC');
$sql->execute([
    "id" => $user['id'],
]);
